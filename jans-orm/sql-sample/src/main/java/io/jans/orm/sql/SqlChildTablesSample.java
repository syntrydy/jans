...
/**
 * @author Yuriy Movchan Date: 08/01/2022
 */
public final class SqlChildTablesSample {

    private static final Logger LOG = LoggerFactory.getLogger(SqlConnectionProvider.class);

    private SqlChildTablesSample() {
    }
    ...
    public static void main(String[] args) {
        ...
        newUser.setCustomTest1("Test1");
        newUser.setCustomTest2("Test2");
        newUser.setCustomTest3("Test3");
        newUser.setCustomTest4("Test4");
		...
		Filter filter = Filter.createEqualityFilter("transientId", "transientId");
		List<SimpleUser> foundUsers = sqlEntryManager.findEntries("o=jans", SimpleUser.class, filter, SearchScope.SUB,
				null, null, 0, 0, 0);
		LOG.info("Found users: " + foundUsers.size());

		for (SimpleUser foundUser : foundUsers) {
			LOG.info("User with custom_test1 '{}' and 'custom_test2' attribute: " + foundUser.getCustomTest1(), foundUser.getCustomTest2());
		}
  }
